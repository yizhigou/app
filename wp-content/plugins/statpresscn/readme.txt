...
Thanks to [Gianni Diurno](http://gidibao.net/index.php/2008/12/10/statpresscn-in-italiano/ "Gidibao's Cafe") for the Italian locale language support, and [fatcow](http://www.fatcow.com/ "fatcow 肥牛") for Russian locale language, and [reza sh](http://rezaonline.net/blog "reza sh") for Persian, and [Rene](http://wpwebshop.com "WPwebshop from Rene") for Dutch.
...
= fixed the wrong def in spider.dat, thanks to [Alan Danielson](http://www.3threat.net/ "3threat.net")
